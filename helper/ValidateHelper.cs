...
namespace RCApp_Win.Logic.Utility1
{
    ...
    public class ControlPair
    {
        ...
        public void ErrorTip(string formatStr)
        {
            YZWmessagebox.Show(string.Format(formatStr, Name));
        }
    ...
    class RequiredValitator : IValidator
    {
        ...
        public bool Validate(ControlPair controlPair)
        {
